...
function [tree_confusion_matrix, tree_eval_matrix, cross_validation_matrix] = tree_cross_validation(example, target)
    ...
    for i = 1 : k
        ...
        for j = 1 : emotion
            trees{j} = decision_tree_learning(train_input, train_target, j);
        end
